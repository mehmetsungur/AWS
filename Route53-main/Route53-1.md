...
2. Create EC2 that is installed httpd user data in default VPC named: "N.virginia"
```bash
Region: "N.Virginia"
VPC: Default VPC
Subnet: PublicA
    ...
    "Statement": [
        {
            ...
            "Principal": "*",
            "Action": "s3:GetObject",
            "Resource": "arn:aws:s3:::www.migsuntech.xyz"
        }
    ]
}
```
...
- select "www.your DNS name" A-record ---> Edit
